...
public class TestDateInit {
    ...
    public void testDataAdd() {
        ...
        for (int i = 1; i < 64; i++) {
            ...
            Comment savedComment = commentRepository.save(new Comment(post, member, "재밌는 글입니다.", null));
            commentRepository.save(new Comment(post, member2, "재미없는 글입니다. 후후", savedComment));
        }
