...
//            Comment savedComment = commentRepository.save(new Comment(post, member, "댓글 1번.", null));
//            Comment savedComment2 = commentRepository.save(new Comment(post, member, "댓글 2번", null));
//            Comment savedComment3 = commentRepository.save(new Comment(post, member, "댓글 3번", null));
//
//            commentRepository.save(new Comment(post, member2, "대댓글 1번", savedComment));
//            commentRepository.save(new Comment(post, member, "대댓글 2번", savedComment2));
//        }
//
//
